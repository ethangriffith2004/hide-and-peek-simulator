...
- One of the spots is a "joke", where any hiders who choose it are immediately visible (but the seeker still has to look there to count them as found).

I always thought the joke spot was just that: a joke, to use when no one was taking the game seriously. Though, I eventually came across claims that one player intentionally choosing it could improve the hiders' odds of winning. I saw nothing to truly back this up, so I wanted to find out for myself.
